...
import { Headers, Request, RequestInit } from 'node-fetch';

declare namespace Stardog {
  namespace HTTP {
    export type RdfMimeType =
      | 'application/ld+json'
      | 'text/turtle'
      | 'application/rdf+xml'
    ...
    export type ExplainAcceptMimeType = 'text/plain' | 'application/json';
  ...
  export namespace db {
    ...
    function exportData(
      conn: Connection,
      database: string,
      options?: { mimetype: HTTP.RdfMimeType },
    ...
    namespace transaction {
      type Encodings = 'gzip' | 'compress' | 'deflate' | 'identity' | 'br';
    ...
    namespace reasoning {
       ...
       * @param {object} params additional parameters if needed
       */
      function explainInferenceInTransaction(
        conn: Connection,
        database: string,
        transactionId: string,
        inference: string,
        config: transaction.TransactionOptions,
        params?: object
      ): Promise<HTTP.Body>;
       ...
       * @param {object} params additional parameters if needed
       */
      function explainInconsistencyInTransaction(
        conn: Connection,
        database: string,
        transactionId: string,
        options?: { namedGraph: string },
  ...
  export namespace query {
    ...
    function explain(
      ...
      database: string,
      query: string,
      accept?: HTTP.ExplainAcceptMimeType,
      params?: object
    ): Promise<HTTP.Body>;
  ...
  export namespace virtualGraphs {
    ...
    type AllVgOptions = SharedOptions &
      RdbmsOptions &
      MongoOptions &
      CsvOptions;
     ...
     */
    function add<T extends AllVgOptions>(
      conn: Connection,
      name: string,
      mappings: string,
      options: T,
     ...
     * @param {VgMeta} meta database name, data source, and other graph specifications
     */
    function update<T extends AllVgOptions>(
      conn: Connection,
      name: string,
      mappings: string,
      options: T,
  ...
  export namespace dataSources {
    type DataSourceQuery = { query: string; options: object };
     ...
     * @param {Connection} conn the Stardog server connection
     */
    function typeDescription(conn: Connection): Promise<HTTP.Body>;
  }
}
